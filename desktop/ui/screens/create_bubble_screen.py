...
class CreateBubbleScreen(ttk.Frame):
    """Simple placeholder for creating an Interest Bubble, with sidebar."""
    ...
    def __init__(self, parent, show_callback):
        ...
        ttk.Label(card, text="Create Bubble", font=("Segoe UI", 14, "bold")).grid(
        ...
        ttk.Button(btns, text="Create", command=lambda: messagebox.showinfo("Bubble", "(mock) Bubble created")).pack(
            side="right"
        )
